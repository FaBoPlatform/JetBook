...
|機種名|メーカー|認識|
|:--|:--|:--|
|[F710](https://gaming.logicool.co.jp/ja-jp/products/gamepads/f710-wireless-gamepad.html)|logicool|○|


## HID Joystick

一般的なUSB HID Joystickは、`/dev/input/js0`で認識される。
...
while True:
    for e in pygame.event.get(): 
        if e.type == pygame.locals.JOYAXISMOTION: # 7
            ...
            hats_x[e.hat], hats_y[e.hat] = f710.get_hats(e.hat)
